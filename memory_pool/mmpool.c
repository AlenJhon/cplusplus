...
static void* mp_alloc_block(struct mp_pool_s* pool, size_t size) {
    ...
    ssize_t psize = (ssize_t)(h->end - (unsigned char*)h);
...
static void* mp_alloc_large(struct mp_pool_s* pool, ssize_t size) {
    void* p = malloc(size);
    if (p == NULL) {
        return NULL;
    }
...
int main() {
    printf("sizeof(mp_node_s)=%lu\n", sizeof(struct mp_node_s));
    printf("sizeof(mp_pool_s)=%lu\n", sizeof(struct mp_pool_s));
